    ...
    <div className={style.homePage}>
      ...
      <div className={style.table}>
        <div className={style.card}>
          ...
          <h2>Build & Test</h2>
          <p>
            Get work done quicker by building out entire projects or isolating code to test features
            and animations. Want to keep it all under wraps?
          </p>
        ...
        <div className={style.card}>
          ...
          <p>
            Want to upgrade your skills and get noticed? Participating in CodePen Challenges is a
            great way to try something new. We frequently feature these Pens on our homepage and
            across social media!
          </p>
        ...
        <div className={style.card}>
          ...
          <p>
            ...
            Presenting at a conference? Show your code directly in the browser with Presentation
            Mode.
          </p>
